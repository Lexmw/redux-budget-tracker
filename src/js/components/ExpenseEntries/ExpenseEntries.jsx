...
//this is to import the action creators
import{
...
export default class ExpenseEntries extends React.Component {
  constructor(props) {
    ...
    //then we need to bind the methods to the context of the componenets
    //because the methods are called back by the event emitters
    this.handleDescriptionInput = this.handleDescriptionInput.bind(this);
    this.handleAmountInput = this.handleDescriptionInput.bind(this);
    this.handleAddExpense = this.handleAddExpense.bind(this);
  }

  handleDescriptionInput(event){
    //dispatch was provdieed by connect()
  ...
  render() {
    // Use the values that were provided by connect()
